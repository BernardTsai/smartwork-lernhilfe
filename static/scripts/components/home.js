      ...
      <div id="home" class="container">
        ...
        <div class="row no-gutters">
          <div class="col-md">
            ...
            <!-- temporary link to quiz creation -->
            <div class="row">
              <div class="col text-center">
                <button v-if="model.type != 'Schüler/Azubi'" type="button" class="btn btn-danger" @click="model.mode = 'settings'; model.submode = '!settings-editquiz';">Quiz Fragen eingeben hier</button>
              </div>
            </div>
