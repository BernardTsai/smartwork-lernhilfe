    ...
    template: `
      <div id="settings-dashboard" class="container">
        ...
        <div class="card my-3 mx-auto" style="max-width: 540px;" @click="this.model.submode='settings-password'">
          <div class="row no-gutters">
            <div class="col-md-2 my-auto d-none d-md-block">
              <img src="./vendor/fontawesome-free-5.12.1-web/svgs/solid/lock.svg" class="card-img p-3" alt="LOGO">
            </div>
            <div class="col-md-10">
              <div class="card-body">
        ...
        <div v-if="model.type=='Administrator'" class="card my-3 mx-auto" style="max-width: 540px;" @click="this.model.submode='settings-logs'">
          <div class="row no-gutters">
            <div class="col-md-2 my-auto d-none d-md-block">
              <img src="./vendor/fontawesome-free-5.12.1-web/svgs/solid/file-code.svg" class="card-img p-3" alt="LOGO">
            </div>
            <div class="col-md-10">
              <div class="card-body">
