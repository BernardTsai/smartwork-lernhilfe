    ...
    template: `
      <div id="settings" class="container">
       ...
       <div id="Sidebar" class="sidebar">
         ...
         <a @click="model.submode='settings-dashboard'">Dashboard</a>
         <a @click="model.submode='settings-password'">Password</a>
       </div>
            ...
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
              <div class="sidebar-sticky">
                <ul class="nav flex-column">
                  <li class="nav-item">
                    <a class="nav-link active" @click="model.submode='settings-dashboard'">
                      <span class="fa fa-home"></span>
                      Dashboard <span class="sr-only">(current)</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" @click="model.submode='settings-password'">
